...
REM ====================================================================
powershell -Command "Write-Host '[1/2] Checking IAM_Service...' -ForegroundColor Yellow"
...
REM ====================================================================
powershell -Command "Write-Host '[2/2] Checking Laboratory_Service...' -ForegroundColor Yellow"
powershell -Command "Write-Host "--------------------------------------------------------------" -ForegroundColor DarkGray"
