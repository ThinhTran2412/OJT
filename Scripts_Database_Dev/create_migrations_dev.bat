...
REM ====================================================================
powershell -Command "Write-Host '[1/4] Creating IAM_Service Migration (DEV): %MIGRATION_NAME%' -ForegroundColor DarkCyan"
...
REM ====================================================================
powershell -Command "Write-Host '[2/4] Creating Laboratory_Service Migration (DEV): %MIGRATION_NAME%' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[3/4] Creating Monitoring_Service Migration (DEV): %MIGRATION_NAME%' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[4/4] Creating Simulator_Service Migration (DEV): %MIGRATION_NAME%' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
