@echo off
REM ====================================================================
REM Master script to update database migrations for ALL services
REM in OJT_Laboratory_Project
REM ====================================================================
REM This script will run migrations for all 4 services:
REM 1. IAM_Service
REM 2. Laboratory_Service  
REM 3. Monitoring_Service
REM 4. Simulator_Service
REM ====================================================================
...
REM ====================================================================
powershell -Command "Write-Host '[1/4] IAM_Service Migration' -ForegroundColor DarkCyan"
...
REM ====================================================================
powershell -Command "Write-Host '[2/4] Laboratory_Service Migration' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[3/4] Monitoring_Service Migration' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '[4/4] Simulator_Service Migration' -ForegroundColor DarkCyan"
powershell -Command "Write-Host '--------------------------------------------------------------' -ForegroundColor DarkGray"
...
REM ====================================================================
powershell -Command "Write-Host '==============================================================' -ForegroundColor Yellow"
powershell -Command "Write-Host '  Migration Summary' -ForegroundColor Cyan"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Yellow"
