...
export default function TestOrderModal({ 
  ...
  const validateForm = () => {
    ...
    // For CREATE mode, only validate servicePackageId
    if (mode === 'create') {
    ...
    // For EDIT mode, validate all patient fields
    if (mode === 'edit') {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (mode === 'create') {
        // CREATE: only identifyNumber, servicePackageId, priority, note
        submitData = {
        ...
        <div className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <div className="p-6">
            ...
            <div className="space-y-6">
              {/* Patient Information Section - Only show for EDIT mode */}
              {mode === 'edit' && (
                <div>
              ...
              <div className={mode === 'edit' ? 'border-t border-gray-200 pt-6' : ''}>
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Order Details</h3>
                <div className="grid grid-cols-1 gap-4">
                  {/* Identify Number - Only for CREATE */}
                  {mode === 'create' && (
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-1">
                        Identify Number <span className="text-red-500">*</span>
                      ...
                      <p className="text-xs text-gray-500 mt-1">Patient's identification number</p>
                    </div>
                  )}
