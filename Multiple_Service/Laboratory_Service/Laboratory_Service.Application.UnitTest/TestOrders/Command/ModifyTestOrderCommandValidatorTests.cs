...
public class ModifyTestOrderCommandValidatorTests
{
    ...
    /// </summary>
    [Fact]
    public void Should_Have_Error_When_UpdatedBy_Is_Zero()
    {
        // Arrange
        var command = new ModifyTestOrderCommand { UpdatedBy = 0 };
    ...
    {
        // Arrange
        var command = new ModifyTestOrderCommand { UpdatedBy = 99 };
