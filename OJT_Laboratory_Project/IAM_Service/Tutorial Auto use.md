# Hướng Dẫn Sử Dụng Script Tự Động - IAM_Service

Thư mục này chứa các script tự động để chạy test và cập nhật database migration cho project IAM_Service.
...
- `IAM_Service.Application.UnitTests/TestResults/coverage/` - Coverage data
- `IAM_Service.Application.UnitTests/TestResults/CoverageReport/` - HTML report
...
- Script sẽ cập nhật database của project **IAM_Service.API**
