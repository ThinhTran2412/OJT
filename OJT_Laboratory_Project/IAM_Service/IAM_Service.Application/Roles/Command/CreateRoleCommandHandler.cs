...
namespace IAM_Service.Application.Roles.Command
{
    ...
    public class CreateRoleCommandHandler : IRequestHandler<CreateRoleCommand, RoleDto>
    {
        ...
        public CreateRoleCommandHandler(IRoleCommandRepository roleRepo, IPrivilegeRepository privRepo)
        {
            _roleRepo = roleRepo;
            _privRepo = privRepo;
        }
        ...
        public async Task<RoleDto> Handle(CreateRoleCommand request, CancellationToken ct)
        {
            ...
            // ✅ AC02: Nếu không có privilegeIds => mặc định READ_ONLY
            List<Privilege> privileges;

            if (dto.PrivilegeIds == null || dto.PrivilegeIds.Count == 0)
            {
            ...
            {
                privileges = await _privRepo.GetPrivilegesByIdsAsync(dto.PrivilegeIds, ct);
