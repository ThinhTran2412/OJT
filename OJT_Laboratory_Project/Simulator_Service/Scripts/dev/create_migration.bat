@echo off
REM ====================================================================
REM Script to CREATE new migration for Simulator_Service
...
REM Change to Simulator_Service directory (go up two levels from dev folder)
cd /d "%~dp0\..\.."
...
if not exist "Simulator_Service.sln" (
    ...
    powershell -Command "Write-Host 'Please run this script from Simulator_Service\Scripts\dev folder.' -ForegroundColor Yellow"
    exit /b 1
)

powershell -Command "Write-Host ''"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '  Creating Simulator_Service Migration (DEVELOPMENT)' -ForegroundColor Cyan"
...
if %ERRORLEVEL% equ 0 (
    powershell -Command "Write-Host ''"
    powershell -Command "Write-Host '✓ Simulator_Service migration created successfully!' -ForegroundColor DarkGreen"
