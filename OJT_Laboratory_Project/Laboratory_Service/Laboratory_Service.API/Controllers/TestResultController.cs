...
namespace Laboratory_Service.API.Controllers
{
    ...
    public class TestResultController : ControllerBase
    {
        ...
        /// <returns></returns>
        [HttpPost("process-from-simulator/{testOrderId}")]
        [SwaggerOperation(
        ...
        public async Task<IActionResult> ProcessTestResultsFromSimulator(Guid testOrderId)
        {
            ...
            var command = new ProcessTestResultMessageCommand { TestOrderId = testOrderId };
