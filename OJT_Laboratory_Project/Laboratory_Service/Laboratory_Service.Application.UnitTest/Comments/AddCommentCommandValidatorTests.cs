...
namespace Laboratory_Service.Application.UnitTest.Comments
{
    public class AddCommentCommandValidatorTests
    {
        ...
        public void Should_Pass_When_Valid_Request_With_TestOrder()
        {
            ...
            var command = new AddCommentCommand(dto, createdBy: 10);
        ...
        [Fact]
        public void Should_Fail_When_Both_TestOrder_And_TestResult_Are_Null()
        {
            var dto = new CreateCommentDto
            {
                TestOrderId = null,
            ...
            result.ShouldHaveValidationErrorFor("Dto")
                .WithErrorMessage("Either TestOrderId or TestResultId must be provided.");
        }
