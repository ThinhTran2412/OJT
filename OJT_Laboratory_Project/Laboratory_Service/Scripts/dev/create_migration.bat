@echo off
REM ====================================================================
REM Script to CREATE new migration for Laboratory_Service
...
REM Change to Laboratory_Service directory (go up two levels from dev folder)
cd /d "%~dp0\..\.."
...
if not exist "Laboratory_Service.sln" (
    ...
    powershell -Command "Write-Host 'Please run this script from Laboratory_Service\Scripts\dev folder.' -ForegroundColor Yellow"
    exit /b 1
)

powershell -Command "Write-Host ''"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '  Creating Laboratory_Service Migration (DEVELOPMENT)' -ForegroundColor Cyan"
