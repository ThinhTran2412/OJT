...
if not exist "Laboratory_Service.sln" (
    ...
    powershell -Command "Write-Host 'Please run this script from Laboratory_Service\Scripts\pro folder.' -ForegroundColor Yellow"
    exit /b 1
)

powershell -Command "Write-Host ''"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Cyan"
powershell -Command "Write-Host '  Creating Laboratory_Service Migration (PRODUCTION)' -ForegroundColor Cyan"
