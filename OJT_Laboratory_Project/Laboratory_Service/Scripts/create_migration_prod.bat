...
REM ====================================================================
REM Usage: create_migration_prod.bat [MigrationName]
REM Example: create_migration_prod.bat "AddNewTable"
REM Note: If MigrationName is not provided, script will prompt for input
REM WARNING: This will create migration using PRODUCTION database config!
REM ====================================================================
...
if not "%~1"=="" (
    ...
    powershell -Command "Write-Host '  Create Migration for Laboratory_Service (PRODUCTION)' -ForegroundColor Red"
    powershell -Command "Write-Host '==============================================================' -ForegroundColor Red"
    powershell -Command "Write-Host ''"
    powershell -Command "Write-Host 'This will create migration using PRODUCTION configuration (Render DB)!' -ForegroundColor Yellow"
    powershell -Command "Write-Host ''"
...
powershell -Command "Write-Host ''"
powershell -Command "Write-Host '==============================================================' -ForegroundColor Red"
powershell -Command "Write-Host '  WARNING: PRODUCTION MIGRATION CREATION' -ForegroundColor Red"
...
powershell -Command "Write-Host '==============================================================' -ForegroundColor Red"
powershell -Command "Write-Host ''"
powershell -Command "Write-Host 'This will create migration using PRODUCTION configuration.' -ForegroundColor Yellow"
...
powershell -Command "Write-Host '  Creating Migration for Laboratory_Service (PRODUCTION)' -ForegroundColor Cyan"
...
REM ====================================================================
REM Laboratory_Service Migration Creation (PRODUCTION)
REM ====================================================================
powershell -Command "Write-Host 'Creating Laboratory_Service Migration (PROD)' -ForegroundColor DarkCyan"
...
if %ERRORLEVEL% equ 0 (
    ...
    powershell -Command "Write-Host '  2. Commit and push migrations:' -ForegroundColor Yellow"
    powershell -Command "Write-Host "     git add Laboratory_Service.Infrastructure/Migrations/*.cs" -ForegroundColor Gray"
    powershell -Command "Write-Host "     git commit -m \"Add migration: %MIGRATION_NAME%\"" -ForegroundColor Gray"
    powershell -Command "Write-Host "     git push" -ForegroundColor Gray"
