...
namespace Laboratory_Service.Application.Comment.Validations
{
    ...
    public class AddCommentCommandValidator : AbstractValidator<AddCommentCommand>
    {
        ...
        public AddCommentCommandValidator()
        {
            ...
            // Must have either TestOrderId or TestResultId
            RuleFor(x => x.Dto)
                .Must(dto => dto.TestOrderId.HasValue || dto.TestResultId.HasValue)
                .WithMessage("Either TestOrderId or TestResultId must be provided.");
        }
    }
}
